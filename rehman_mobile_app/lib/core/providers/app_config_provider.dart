...
class AppConfig {
  ...
  const AppConfig({
    ...
    this.instagram = 'https://www.instagram.com/rehmantravelsofficial',
    this.twitter = 'https://twitter.com/rehmantravel',
    this.youtube = 'https://www.youtube.com/RehmanTravelsOfficial',
  ...
  factory AppConfig.fromJson(Map<String, dynamic> json) {
    ...
    return AppConfig(
      ...
      instagram: social['instagram'] ?? 'https://www.instagram.com/rehmantravelsofficial',
      twitter: social['twitter'] ?? 'https://twitter.com/rehmantravel',
      youtube: social['youtube'] ?? 'https://www.youtube.com/RehmanTravelsOfficial',
