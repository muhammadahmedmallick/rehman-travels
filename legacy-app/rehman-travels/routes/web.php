...
Route::group(['middleware' => ['block.ip']], function () {
    ...
    Route::group(['prefix' => 'ticketing','middleware' => ['block.ip']], function () {
        ...
        Route::get('/cheapest-fare-flight', 'Website\Ticketing\FlightSearchController@cheapestFareFlight')->name('cheapestFareFlight');
        Route::post('/cheapest-fare-airshopping-request', 'Website\Ticketing\CheapestFareAirShoppingController@cheapestFareAirshoppingRequest')->name('cheapestFareAirshoppingRequest')->middleware('block.ip');
        Route::post('/chunked-flight-search', 'Website\Ticketing\ChunkedFlightSearchController@chunkedFlightSearch')->name('chunkedFlightSearch')->middleware('block.ip');
        ...
        Route::get('/cheapest-fare-flight-order-create', 'Website\Ticketing\OrderCreateController@cheapestFareFlightOrderCreate')->name('cheapestFareFlightOrderCreate')->middleware('block.ip');
        Route::post('/cheapest-fare-flight-order-create-request', 'Website\Ticketing\CheapestFareFlightOrderCreateController@cheapestFareFlightOrderCreateRequest')->name('cheapestFareFlightOrderCreateRequest')->middleware(['log.ip:orderCreate','block.ip']);
    ...
    Route::group(['prefix' => 'payonline'], function () {
        ...
        Route::post('/cheapest-fare-order-hbl-pay-online-request', 'Common\Hblpay\HblpayController@hblpayToken')->name('hblpayToken');
        Route::get('/cheapest-fare-hbl-pay-success-response', 'Common\Hblpay\HblpayController@hblpaySuccess')->name('hblpaySuccess');
        Route::get('/cheapest-fare-hbl-pay-fail-response', 'Common\Hblpay\HblpayController@hblpayFail')->name('hblpayFail');
    ...
    Route::group(['prefix' => 'visa'], function () {
        Route::get('/', 'Website\VisaController@visaListing')->name('visaListing');
