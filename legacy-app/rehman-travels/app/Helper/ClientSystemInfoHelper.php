...
class ClientSystemInfoHelper
{
    ...
    public static function getCurrentPage(){
        $getFullPath = $_SERVER['HTTP_REFERER'];
        $currentPage = explode("/", $getFullPath);
        $pageName = str_replace("-"," ", end($currentPage));
        return $pageName;
    }
    public static function getreferalUrl(){
       $getreferalUrl = $_SERVER['HTTP_REFERER'];
       return $getreferalUrl;
    }
}
