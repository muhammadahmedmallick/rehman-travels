...
@if(!empty(data_get($paymentProvider, 'TransactionStatus')))
    <table class="table-main print-main-table">
        <tbody>
        ...
        <tr>
            ...
            <td><b><u><i><font size='2' color='#ff0000'>{{($paymentProvider->TransactionStatus ?? ($paymentProvider['TransactionStatus'] ?? ''))}}</font></i></u></b></td>
