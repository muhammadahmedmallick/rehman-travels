        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td>Email:{{(!empty($orderProvider['contacts'][0]['email']) ? $orderProvider['contacts'][0]['email'] : 'bdm@rehmantravel.com')}},
                        Phone No # {{(!empty($orderProvider['contacts'][0]['phone']) ? $orderProvider['contacts'][0]['phone'] : '+9251111785786')}}
                    </td>
                </tr>
                <tr class="tabletitle"><th colspan="7" class="p-1"></th></tr>
                <tr>
        ...
        <table class="table-main print-main-table">
            <tbody>
                <tr>
                    ...
                    <td colspan="1">Fare:{{(!empty($orderProvider['price']['currency']) ? $orderProvider['price']['currency'] : 'PKR')}} {{(!empty($orderProvider['price']['baseFare']) ? $orderProvider['price']['baseFare'] : 0)}}</td>
