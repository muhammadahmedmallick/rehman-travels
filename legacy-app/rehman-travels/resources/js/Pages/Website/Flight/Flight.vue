...
<template>
    <GuestLayout v-slot="{selectedCurrencyFromParent}" :selectedCurrencyFromChild="selectedCurrencyFromChild">
        <SearchFlight @selectedCurrencyFromChildToParent="selectedCurrencyFromChildToParent" :selectedCurrencyFromParent="selectedCurrencyFromParent"></SearchFlight>
        <div class="-mt-56 md:-mt-28">
            <div class="md:px-4 py-4 xs:p-6 mx-auto w-[90%] sm:w-[78%] xl:w-[88%] 2xl:w-[78%]">
                <div class="bg-white rounded-lg xs:text-justify p-4">
                    <p class="text-justify text-gray-500" v-html="$page.props.flightDetails.shortDescription"></p>
                    <p class="text-justify text-gray-500" v-html="$page.props.flightDetails.description"></p>
                </div>
                <div class="bg-white rounded-lg xs:text-justify">
                    <div class="my-3 w-full">
                        <h3
                            class="text-xl uppercase rounded bg-bgRGTBaseColor text-white p-[0rem_0.7rem] mb-3 font-medium leading-[2.875rem] md:text-start text-center">
