        ...
        <section class="bg-gray-200">
            <div class="banner md:h-[275px] h-[170px]" :style="'background-image:url('+banner+')'">
                <h1
                    ...
                    {{ $page.props.worldTour.packageTitle }}</h1>
            </div>
                    ...
                    <div
                        ...
                        <div class="px-4">
                            <div class="col-span-12 mb-4">
                                <p class="text-justify mt-2 text-lg mb-0 ck-Detail" v-html="$page.props.worldTour.shortDescription">
                                </p>
                            </div>
                            <div class="col-span-12 text-justify mb-5 ck-Detail" v-html="$page.props.worldTour.description">
                            </div>
                        ...
                        <div class="col-span-12 sm:mx-4 ">
                            <div class="relative flex justify-center items-center">
                                <div class=" rounded-[10px] w-full hover:bg-white">
                                    <img :alt="$page.props.worldTour.packageTitle" class="rounded-md w-full"
                                        :src="'/assets/International Tour/' + $page.props.worldTour.cardImage">
                                </div>
                                <div class="absolute">
                                    <p
                                        class="text-white font-bold text-4xl capitalize drop-shadow-[2px_2px_1px_black] pl-14 sm:pl-0">
                                        {{ $page.props.worldTour.packageTitle }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:mx-4">
                        ...
                        <div class="col-span-12 sm:mx-4" v-if="$page.props.getNum.whatsapp !== '' || $page.props.getNum.landline !== ''">
                            <div
                                ...
                                <i class=" fa fa-phone text-blue-600"></i> <a href="tel:923345164637"
                                    class="text-blue-800 text-[20px]">(+92)3345164637</a>
                            </div>
                        </div>
                    </div>
                </div>
