        ...
        <section class="bg-gray-200">
            <div class="banner md:h-[275px] h-[170px]" :style="'background-image:url('+banner+')'">
                <h2
                    ...
                    {{ $page.props.studyImmigration.contentDetails.packageTitle }}</h2>
            </div>
            <div class="w-[90%] mx-auto">
                <div class="grid grid-cols-12 mt-4">
                    <div class=" col-span-12 lg:col-span-8 mb-4 relative flex flex-col break-words bg-white bg-clip-border border-[1px] border-solid border-[rgba(0,0,0,.125)] rounded-[0.25rem]">
                        <div class="px-4">
                            ...
                            <div class="col-span-12 mb-4">
                                <p class="text-justify mt-2 text-lg mb-0 ck-Detail" v-html="$page.props.studyImmigration.contentDetails.shortDescription">
                                </p>
                            </div>
                            <div class="col-span-12 text-justify mb-5 ck-Detail" v-html="$page.props.studyImmigration.contentDetails.description">
                            </div>
                        ...
                        <div class="md:pt-3  py-0 md:py-0 hidden md:block">
                            <div class="bg-white rounded-lg xs:text-justify">
                                <div class="my-3 w-full">
                                    <h3 class="text-xl uppercase bg-bgRGTBaseColor text-white p-[0rem_0.7rem] mb-3 font-medium leading-[2.875rem] md:text-start text-center">
                    ...
                    <div class="sm:col-span-12 lg:col-span-4 sm:mx-3 sm:mt-0 mt-4 col-span-12 w-full">
                        <div class="col-span-12 sm:mx-4 ">
                            <div class="relative flex justify-center items-center">
                                <div class=" rounded-[10px] w-full hover:bg-white">
                                    <img :alt="$page.props.studyImmigration.contentDetails.packageTitle" class="rounded-md w-full"
                                        :src="'/assets/' + $page.props.studyImmigration.contentDetails.cardImage">
                                </div>
                                <div class="absolute">
                                    <h1
                                        class="text-white font-bold text-4xl capitalize drop-shadow-[2px_2px_1px_black] pl-14 sm:pl-0">
                                        {{ $page.props.studyImmigration.contentDetails.packageTitle }}</h1>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:mx-4">
                        ...
                        <div class="col-span-12 sm:mx-4 ">
                            <div class="my-3 border-2 border-dashed border-gray-400 p-3 bg-gray-200 rounded text-center justify-center">
                                ...
                                <i class=" fa fa-phone text-blue-600"></i> <a :href="'tel:'+ $page.props.studyImmigration.phoneNo"
                                    class="text-blue-800 text-[20px]">{{ $page.props.studyImmigration.phoneNo }}</a>
                            </div>
                        </div>
                    </div>
                </div>
