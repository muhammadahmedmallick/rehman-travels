        ...
        <section class="bg-gray-200">
            <div class="banner md:h-[275px] h-[170px]" :style="'background-image:url(' + banner + ')'">
                <h1
                    ...
                    {{ $page.props.travelagency.packageTitle }}</h1>
            </div>
                        ...
                        <div class="p-4">
                            <div class="col-span-12 mb-4">
                                <p class="text-justify mt-2 text-lg mb-0 ck-Detail"
                                    v-html="$page.props.travelagency.shortDescription">
                                </p>
                            </div>
                            <div class="col-span-12 text-justify mb-5 ck-Detail"
                                v-html="$page.props.travelagency.description">
                            </div>
                    ...
                    <div class="sm:col-span-12 lg:col-span-4 sm:mx-3 sm:mt-0 mt-4 col-span-12 w-full">
                        ...
                        <div class="col-span-12 sm:mx-4 ">
                            <div
                                ...
                                <i class=" fa fa-phone text-blue-600"></i> <a href="tel:923345488801"
                                    class="text-blue-800">(+92)3345488801</a>
                            </div>
                        </div>
                    </div>
                </div>
