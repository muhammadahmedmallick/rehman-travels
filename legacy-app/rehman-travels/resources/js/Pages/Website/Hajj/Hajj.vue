        ...
        <section class="bg-gray-200">
            <div class="banner md:h-[275px] h-[170px]" :style="'background-image:url(' + banner + ')'">
                <h1
                    ...
                    {{ $page.props.hajjPackages.packageTitle }}</h1>
            </div>
                ...
                <div class="grid grid-cols-12 mt-4">
                    <div
                        ...
                        <div class="w-full flex justify-end">
                            <a href="/updatedHajj2025-RehmanTravel.pdf" class="text-white p-[4px_10px_4px_10px] mr-1 sm:mr-4 bg-green-600 mt-2 text-sm sm:text-base rounded-md print:hidden">
                                <i class="fa fa-download mt-1"></i> 
                                Download Executive Hajj Packages 2025
                            </a>
                        </div>
                        <div class="p-4">
                            <div class="col-span-12 mb-4">
                                <p class="text-justify mt-2 text-lg mb-0 ck-Detail"
                                    v-html="$page.props.hajjPackages.shortDescription">
                                </p>
                            </div>
                            <div class="col-span-12 text-justify mb-5 ck-Detail"
                                v-html="$page.props.hajjPackages.description">
                            </div>
                            <div class="w-full flex justify-center mb-5 sm:mb-10">
                                <a href="/updatedHajj2025-RehmanTravel.pdf" class="text-white p-[4px_10px_4px_10px] bg-green-600 mt-2 text-sm sm:text-base rounded-md print:hidden">
                                    <i class="fa fa-download mt-1"></i> 
                                    Download Executive Hajj Packages 2025
                                </a>
                            </div>
                            <ExtraPhoneEmailDetails></ExtraPhoneEmailDetails>
                        </div>
                        <!-- Contact Form -->
...
export default {
    ...
    watch: {
        name(val) {
        this.form.customers.name = val.replace(/\W/g, "");
        },
    },
    methods: {
        submitDetails() {
