...
const VisaTypes = () => {
  ...
  const { data: visaTypes, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await visaTypesAPI.getAll({ search: searchTerm });
  ...
  const updateMutation = useMutation({
    mutationFn: ({ slug, data }) => visaTypesAPI.update(slug, data),
    onSuccess: () => {
      queryClient.invalidateQueries(['visa-types']);
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage visa type categories</p>
        </div>
        <button
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  placeholder="e.g., singapore-visa"
                  className="input"
                />
